...
//        PasajeDatos.guardarPasaje(pasaje2);
...
//    ********************************ALOJAMIENTO*******************************
//        Alojamiento alo1 = new Alojamiento(CiudadDatos.buscarCiudad("San Miguel de Tucumán"), LocalDate.of(2023, 5, 20), LocalDate.of(2023, 8, 15), Servicio.COMPLETO, 203555.58, true);
//        AlojamientoDatos.alojamientoGuardar(alo1);

////  *********************************PAQUETES*********************************
//    
//        Paquete paq1 = new Paquete(8,CiudadDatos.buscarCiudad("San Miguel de Tucumán"), CiudadDatos.buscarCiudad("Bariloche"), AlojamientoDatos.buscarAlojamiento(7), PasajeDatos.buscarPasaje(5));
//        PaqueteDatos.guardarPaquete(paq1);

//        PaqueteDatos.modicarPaquete(paq1);
//    PaqueteDatos.eliminarpaquete(8);
    }
